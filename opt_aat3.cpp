...
float pop_dec() {
	...
	int r_d = stoi(ran_i);   // stoi converts a string to int
...
void init_table() {
	cout << setw(5) << "Str No." << setw(10) << " Population, x" << setw(10) << "Population, y" << setw(10) << "Binary, x" << setw(10) << "Binary, y" << endl
	     << setw(5) << "1"        << setw(10) << x1		      << yy1     <<   endl 
	     << setw(5) << "2" 	      << setw(10) << x2 << setw(10) << y2 << setw(10) << endl
	     << setw(5) << "3"	      << setw(10) << x3 << setw(10) << y3 << setw(10) << endl
	     << setw(5) << "4"        << setw(10) << x4 << setw(10) << y4 << setw(10) << endl;
	     }
